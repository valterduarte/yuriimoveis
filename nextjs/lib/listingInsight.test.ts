...
describe('buildListingInsight', () => {
  it('returns null when the sample is too small to be meaningful', () => {
    expect(buildListingInsight([make(300000, 50, 'Centro')], { cidadeName: 'Osasco', total: 1, subject: 'apartamentos' })).toBeNull()
    expect(buildListingInsight([], { cidadeName: 'Osasco', total: 0, subject: 'apartamentos' })).toBeNull()
  })
  ...
  it('quotes a real price and area range when the sample covers all results', () => {
    ...
    const insight = assertInsight(buildListingInsight(imoveis, { cidadeName: 'Osasco', total: 3, subject: 'apartamentos de 2 quartos' }))
  ...
  it('frames price as "a partir de" when the sample does not cover every result', () => {
    ...
    const insight = assertInsight(buildListingInsight(imoveis, { cidadeName: 'Osasco', total: 40, subject: 'apartamentos' }))
  ...
  it('surfaces the most frequent neighbourhoods', () => {
    ...
    const insight = assertInsight(buildListingInsight(imoveis, { cidadeName: 'Osasco', total: 5, subject: 'apartamentos' }))
  ...
  it('counts MCMV-eligible units and pluralises correctly', () => {
    ...
    const insight = assertInsight(buildListingInsight(imoveis, { cidadeName: 'Osasco', total: 3, subject: 'apartamentos' }))
  ...
  it('omits the MCMV sentence when no unit fits the cap', () => {
    ...
    const insight = assertInsight(buildListingInsight(imoveis, { cidadeName: 'Barueri', total: 3, subject: 'apartamentos de alto padrão' }))
