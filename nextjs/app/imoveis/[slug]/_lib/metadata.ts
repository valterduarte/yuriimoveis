...
import { imovelSlug, formatNeighborhoodName, buildSeoDescription, ogImageUrl, propertyOgImageUrl, formatPrice } from '../../../../utils/imovelUtils'
...
export async function buildPropertyMetadata(id: string): Promise<Metadata> {
  ...
  return buildPageMetadata({
    ...
    ogImage: propertyOgImageUrl(rawImage, {
