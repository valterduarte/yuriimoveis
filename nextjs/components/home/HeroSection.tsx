...
export default function HeroSection({ imageUrl, cidadesByTipo, bairrosPorCidade }: HeroSectionProps) {
  return (
    <section aria-labelledby="hero-heading" className="relative min-h-screen md:min-h-[85vh] flex items-center -mt-16 md:-mt-20 overflow-hidden">
      <Image
        src={imageUrl}
      ...
      />
      <div aria-hidden="true" className="absolute inset-0 bg-gradient-to-r from-dark/85 via-dark/70 to-dark/40" />
      <div className="relative container mx-auto px-6 pt-28 pb-12 md:pt-32 md:pb-16">
        <div className="max-w-2xl mb-10">
          ...
          <h1 id="hero-heading" className="text-4xl sm:text-5xl md:text-7xl font-black text-white leading-none mb-6 uppercase tracking-tight">
