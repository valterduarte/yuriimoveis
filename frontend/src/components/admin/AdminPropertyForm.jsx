  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                value={form.parcela_display}
                onChange={e => updateField('parcela_display', e.target.value)}
            ...
            <div>
              ...
              <input
                value={form.parcela_label}
                onChange={e => updateField('parcela_label', e.target.value)}
      ...
      <div className="bg-white border border-gray-200 p-6">
        ...
        <button
          type="button"
          onClick={() => updateField('descricao', DESCRIPTION_TEMPLATE)}
