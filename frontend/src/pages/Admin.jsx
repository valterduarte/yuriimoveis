...
import { ADMIN_PROPERTIES_LIMIT } from '../constants'
...
export default function Admin() {
  const { username, setUsername, password, setPassword, isAuthenticated, loading: authLoading, error: authError, authHeader, handleLogin, handleLogout } = useAdminAuth()
        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {!isFormView ? (
              ...
              <button
                onClick={() => { setActiveView('list'); setMessage(null) }}
