...
export const SITE_URL = 'https://yuriimoveis.com.br'
...
export const CLOUDINARY_CLOUD   = import.meta.env.VITE_CLOUDINARY_CLOUD  || 'dfl3eskr9'
export const CLOUDINARY_PRESET  = import.meta.env.VITE_CLOUDINARY_PRESET || 'Yuri-upload'
